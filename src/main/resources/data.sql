...
-- ASIGNAR ROLES
-- ================================
UPDATE users SET role_id = 1 WHERE username = 'juan01';
UPDATE users SET role_id = 1 WHERE username = 'maria02';
UPDATE users SET role_id = 2 WHERE username = 'carlos03';
UPDATE users SET role_id = 3 WHERE username = 'ana04';

-- ================================
-- ADVERTENCIA
-- ================================
INSERT IGNORE INTO Advertencia
...
-- FUENTE CONFIABLE
-- ================================
INSERT IGNORE INTO Fuente_Confiable
